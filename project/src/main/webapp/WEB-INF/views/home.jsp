...
<html lang="en" data-bs-theme="auto">
  ...
  <body>
    ...
    <!--  top menu TODO 회원 가입시 session이나 request에 id가지고 있어서 보여주고 싶은 메뉴만 보여주기.   -->
    <nav class="navbar navbar-expand-md bg-dark sticky-top border-bottom" data-bs-theme="dark">
      <div class="container">
        <a class="navbar-brand d-md-none" href="/">
          <svg class="bi" width="24" height="24"><use xlink:href="#aperture"/>HOME</svg>
          HOME
        </a>
    ...
    <main>
      <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-body-tertiary">
        <div class="col-md-6 p-lg-5 mx-auto my-5">
          <h1 class="display-3 fw-bold">Welcome JSP PAGE</h1>
          <h3 class="fw-normal text-muted mb-3">USE JSP | SPRING BOOT | BOOTSTRAP</h3>
